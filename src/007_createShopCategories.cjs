      ...
      productSets: [
        {
          attributes: [
            {
              name: "category",
              include: ["yScherbaLevel1Category"],
            },
          ],
        },
      ],
      ...
      productSets: [
        {
          attributes: [
            {
              name: "category",
              include: ["yScherbaLevel1Category|yScherbaLevel2Category"],
            },
          ],
        },
      ],
      ...
      productSets: [
        {
          attributes: [
            {
              name: "category",
              include: ["yScherbaLevel1Category|yScherbaLevel2Category|yScherbaLevel3Category"],
            },
          ],
        },
      ],
