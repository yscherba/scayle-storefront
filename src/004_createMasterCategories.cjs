...
async function createMasterCategories() {
  ...
  const masterCategories = [
    {
      path: ["yScherbaLevel1Category"],
    },
    {
      path: ["yScherbaLevel1Category", "yScherbaLevel2Category"],
      attributes: [
        {
          name: "color",
          type: "simple",
    ...
    {
      path: ["yScherbaLevel1Category", "yScherbaLevel2Category", "yScherbaLevel3Category"], // We don't need to define mandatory attributes here, as this has been covered by the Clothing Category
    },
  ];
